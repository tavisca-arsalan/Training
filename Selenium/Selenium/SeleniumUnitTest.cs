...
namespace AspAutomationTesting
{
    ...
    public class SeleniumUnitTest
    {
        ...
        public void HrLoginTest()
        {
            ...
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox1")).SendKeys("gdr.aic@gmail.com");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox2")).SendKeys("test143");
        ...
        public void CheckRemarkCreatedTest()
        {
            ...
            driver.Navigate().GoToUrl("http://localhost:58084/Login.aspx");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox1")).SendKeys("gdr.aic@gmail.com");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox2")).SendKeys("ntest123");
        ...
        public void HrPasswordChangeSuccessTest()
        {
            ...
            driver.Manage().Timeouts().ImplicitlyWait(TimeSpan.FromMilliseconds(2000));
            driver.Navigate().GoToUrl("http://localhost:58084/Login.aspx");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox1")).SendKeys("a12@gmail.com");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox2")).SendKeys("a123");
            driver.FindElement(By.Name("ctl00$MainContent$LoginUserControl1$LoginButton")).Click();
        ...
        public void HrPasswordChangeFailTest()
        {
            ...
            driver.Manage().Timeouts().ImplicitlyWait(TimeSpan.FromMilliseconds(2000));
            driver.Navigate().GoToUrl("http://localhost:58084/Login.aspx");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox1")).SendKeys("abc@gmail.com");
            driver.FindElement(By.Id("MainContent_LoginUserControl1_TextBox2")).SendKeys("abc");
            driver.FindElement(By.Name("ctl00$MainContent$LoginUserControl1$LoginButton")).Click();
            driver.FindElement(By.Id("MainContent_PasswordChange")).Click();
